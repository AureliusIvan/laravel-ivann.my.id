        ...
        <>
            <Head>
                ...
                <meta name="description" content={
                    `Welcome to ${page?.companyData?.company_name} official website. ${page?.companyData?.company_description} 🏠`
                } />
                ...
                <meta property="og:title" content={page?.companyData?.company_name} />
                <meta property="og:description" content={`Welcome to ${page?.companyData?.company_name} official website. ${page?.companyData?.company_description} 🏠`} />
